...
import com.jiayuan.shuibiao.view.HistoryTaskFilterPopupWindow;
...
public class HistoryTaskListMapActivity extends BaseActivity
        implements HistoryTaskFilterPopupWindow.Callback, LoadListView.IloadListener {
    ...
    HistoryTaskFilterPopupWindow popupWindow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_task_list_map);
        ...
        historyTaskAdapter = new HistoryTaskAdapter(taskList, this);
        ...
        popupWindow = new HistoryTaskFilterPopupWindow(this);
        ...
        OkHttpUtils.post().
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ToastUtil.toast(HistoryTaskListMapActivity.this, "请求异常，请稍后重试！");
                        hideProgress();
                    }
                        ...
                        try{
                            ...
                            if (StringUtils.equals(resultDto.getResult(), "1")) {
                                ...
                                if(planListDto.getTasklist()==null || planListDto.getTasklist().size()==0){
                                    ...
                                    ToastUtil.toast(HistoryTaskListMapActivity.this,"查无数据");
                                    return;
                                }
                                ...
                                ToastUtil.toast(HistoryTaskListMapActivity.this, resultDto.getMsg());
                            }
                        }catch(Exception e){
                            e.printStackTrace();
                            ToastUtil.toast(HistoryTaskListMapActivity.this, "数据返回异常");
                        }
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            overlayOptionsList.add(overlayOptions);
            historyTaskAdapter.setCurrLocation(currLocation);
