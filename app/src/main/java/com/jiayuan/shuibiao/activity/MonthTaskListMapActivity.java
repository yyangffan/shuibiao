...
public class MonthTaskListMapActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month_task_list_map);
        ...
        OkHttpUtils.post().
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ToastUtil.toast(MonthTaskListMapActivity.this, "请求异常，请稍后重试！");
                        hideProgress();
                    }
                            ...
                            if (StringUtils.equals(resultDto.getResult(), "1")) {
                                ...
                                if(planListDto.getTasklist()==null || planListDto.getTasklist().size()==0){
                                    if(loadFlag==1){
                                        ...
                                        ToastUtil.toast(MonthTaskListMapActivity.this,"查无数据");
                                    }else{
                                        listview.loadComplete();
                                        ToastUtil.toast(MonthTaskListMapActivity.this,"没有更多数据");
                                    }
                                    return;
                                }
                                ...
                                ToastUtil.toast(MonthTaskListMapActivity.this, resultDto.getMsg());
                            }
                        }catch(Exception e){
                            e.printStackTrace();
                            ToastUtil.toast(MonthTaskListMapActivity.this, "数据返回异常");
                        }
