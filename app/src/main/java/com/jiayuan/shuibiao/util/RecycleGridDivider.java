...
public class RecycleGridDivider extends RecyclerView.ItemDecoration {
    ...
    public RecycleGridDivider(int space) {
        this(space, R.color.divider_line);
    }
...
//                if (i >= (2 * span) && i < (3 * span)) {//如果是第三排的话
//                    if (childPosition % span == 0) {
//                        outRect.set(0, 6*space, offset, 0);
//                    } else if (childPosition % span == span - 1) {
//                        outRect.set(offset, 6*space, 0, 0);
//                    } else {
//                        outRect.set(offset, 6*space, offset, 0);
//                    }
//                } else {
                    if (childPosition % span == 0) {
